                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-sub dk">
                            ...
                            <li>
                                <a href="<?php echo e(url('activity/create')); ?>">
                                    <span>新建活动</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('activity')); ?>">
                                    <span>活动列表</span>
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-sub dk">
                            <li>
                                <a href="<?php echo e(url('purview')); ?>">
                                    <span>权限列表</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('purview/create')); ?>">
                                    <span>新增权限</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?php echo e(url('role/create')); ?>">
                                    <span>新增角色</span>
                                </a>
                            </li>
                        </ul>
