...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('libs/assets/animate.css/animate.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('libs/assets/font-awesome/css/font-awesome.min.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('libs/assets/simple-line-icons/css/simple-line-icons.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('libs/jquery/bootstrap/dist/css/bootstrap.css')); ?>" type="text/css" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/activity.css')); ?>" type="text/css" />
...
<script src="<?php echo e(asset('js/ui-jp.config.js')); ?>"></script>
<script src="<?php echo e(asset('js/ui-jp.js')); ?>"></script>
<script src="<?php echo e(asset('js/ui-nav.js')); ?>"></script>
<script src="<?php echo e(asset('js/ui-toggle.js')); ?>"></script>
