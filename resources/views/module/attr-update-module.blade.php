...
<div class="col-sm-10">
    <div class="row">
        ...
        <div class="col-md-2">
            <input type="text" class="form-control" name="old_name[]" value="{{$value['name']}}" placeholder="中文名称" required>
        </div>
        <div class="col-md-2">
            <input type="text" class="form-control" name="old_field[]" value="{{$value['field']}}" placeholder="字段名称（纯字母）,最多32个字符" required>
        </div>
        <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-2">
            <input type="number" class="form-control" name="oldLength[]" value="{{$value['length']}}" placeholder="长度，默认255">
        </div>
        <div class="col-md-2">
            <input type="text" class="form-control" name="oldDefault[]" value="{{$value['default']}}" placeholder="默认值，可为空">
        </div>
        <div class="col-md-2">
