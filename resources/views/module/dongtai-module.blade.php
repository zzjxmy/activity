...
<div class="form-group dongtai-module hidden">
    ...
    <div class="col-sm-10" id="dongtai-module-input">
        ...
        <div>
            ...
            <input name="dongtai[callBack]" value="" type="text" class="form-control" style="width: 500px;" placeholder="回调函数（可为空）--格式：\App\Http\Controller\CallBackController::callBack">
        </div>
    </div>
</div>