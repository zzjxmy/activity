<div class="hidden form-group attr-parent" id="activity_add_attr">
    ...
    <div class="col-sm-10">
        <div class="row pb-sm">
            ...
            <div class="col-md-2">
                <input type="text" name="comment[]" value="" class="form-control" placeholder="字段值描述，可为空">
            </div>
            <div class="col-md-2">
                <input type="text" name="explode[]" value="" class="form-control" placeholder="多内容分隔符，可为空">
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <select name="unique[]" class="form-control m-b">
                    <option value="0">值不唯一</option>
                    <option value="1">值唯一</option>
                </select>
            </div>
            <div class="col-md-2">
                <select name="search[]" class="form-control m-b">
                    <option value="0">非搜索</option>
